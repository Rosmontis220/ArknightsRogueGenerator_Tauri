...
export const ICON_PATHS = {
	...
	/**
	 * The sound entry. A speaker with two waves.
	 *
	 * Drawn rather than borrowed: nothing else in the set reads as audio, and this is the
	 * one entry whose icon has to say "sound" from across the settings list.
	 */
	volume: [
		'M11 4.8 6.7 8.9H3.2v6.2h3.5L11 19.2V4.8Z',
		'M14.9 9.2a4.1 4.1 0 0 1 0 5.6',
		'M17.7 6.4a8 8 0 0 1 0 11.2'
	],
