...
const ZH_CN: Record<string, string> = {
	...
	'generator.laochan2.description': '限定肉鸽：萨卡兹的无终奇语；这一局只能使用以下 12 位六星干员的一技能',
	...
	'settings.sound.summary': '所有音效的音量',
	...
	'sound.volume': '音量',
	'sound.help': '控制全部音效，包括投钱问路落币的声音。0 为静音。',
...
const EN: Record<string, string> = {
	...
	'generator.laochan2.description':
		"Locked to Sarkaz's Furnaceside Fables; this run may only use skill 1 of the twelve six-stars below",
	'generator.laochan2.constraint':
	...
	'settings.sound.summary': 'The volume of every sound effect',
	...
	'sound.volume': 'Volume',
	'sound.help':
		'Controls every sound the app makes, including the coins landing after a toss. 0 is silent.',
