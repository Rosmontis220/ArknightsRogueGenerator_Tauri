...
const ZH_CN: Record<string, string> = {
	 ...
	 * toss, and they are the game's exact wording — 听凭天命 is *not* the common 听天由命
	 * idiom, and the two type ones are the short forms the game prints, not sentences
	 * about what the coins bring.
	 */
	...
	'about.featureFortune': '首页投钱问路：岁的界园志异可投的 101 枚通宝，每天三枚',
	'about.developer': '开发者',
...
const EN: Record<string, string> = {
	...
	/*
	 * 投钱问路; see the note on the Chinese catalogue. These three are the game's own English
	 * messages, quoted verbatim on the wiki's list page along with the colour each is printed
	 * in — which is why they read differently from the Chinese: the localisation is a
	 * paraphrase, and 花钱如愿 became a sentence about what the coin brings.
	 */
	...
	'about.featureFortune':
		'Tongbao Toss on the home page: the 101 tossable coins of Sui’s Garden of Grotesqueries, three a day',
